...
class Program
{
    static void Main(string[] args)
    {
        ...
        // 1. Do this 3 times - A loops allows code to be executed multiple times
        //       Ask user to enter a number
        //       Get the number from user
        //       Add Number to sum right away
        //
        // 2. Display the sum of the numbers
        
        // Data we need:
        //
        // 1. a place to hold the number entered by user
        ...
        //         b. increment the variable according to the lsst part of the loop
        //             go back to #2
        ...
        for (int i = 0; i < 3; i++) // i=0,1,2 inside the loop - 3 causes it to exit
        {
            ...
            firstEntry = int.Parse(theUserResponse); // Convert data into an int
