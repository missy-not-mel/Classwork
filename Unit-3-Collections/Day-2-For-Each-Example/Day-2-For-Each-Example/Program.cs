...
class Program
{
    static void Main(string[] args)
    {
        ...
        for (int i=0; i < splitSentence.Count; i++)      //To process a List - use .Count to get # of elements
        {
            ...
            //       i+1 in the output for WrtieLine, it thinks I want to take the value of i and stick a 2 after it
        ...
        //
        // Syntax: foreach(datatype variable-name in array-of-List)
        ...
        //         
        // Foreach goes through the array or List from start to end assigning each element to that variable
        //
        ...
        // for-each ALWAYS processes from the beginning to end. Can't change it!
        // for-loop you know which element number you're processing by using the value in i
        ...
        // }
        //
        // We always do the loop process at zero
        //    because the condition is checked at the end of the loop process 
        ...
        {
            Console.WriteLine("Word #: " + (elementNumber+1) + " is: " + splitSentence[currentElementNumber]);
